...
#     ../../../tools/submit.sh scripts/submit_tapAdj_approxAdv.sh

#SBATCH -J DINO_1deg_tapAdj_approxAdv    # job name: names the log file only; the run directory is named from build_info.txt
...
EXPECT_RUN_TOKEN=tapAdj_ckpAll_approxAdv     # refuse a build directory holding any other variant
...
#
#     IMPACTS_DURATION_DAYS=3660 ../../../tools/submit.sh scripts/submit_tapAdj_approxAdv.sh
#
